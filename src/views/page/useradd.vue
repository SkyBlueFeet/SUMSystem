<template>
<el-col :offset="8" :span="12" class="edit">
  <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm" :inline-message="false">
  ...
  <el-form-item label="姓名" prop="name">
      <el-input v-model="ruleForm2.name" @input.native="log(ruleForm2.name.length)"></el-input>
    </el-form-item>
  <el-form-item label="身份证号" prop="CardID">
    <el-input v-model.number="ruleForm2.CardID"></el-input>
  </el-form-item>
  <el-form-item>
